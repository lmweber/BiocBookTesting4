...
intro <- tryCatch(
    {
        description <- packageDescription("BiocBookTesting4")
...
👉 [ghcr.io/lmweber/biocbooktesting4](https://ghcr.io/lmweber/biocbooktesting4) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting4:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lmweber/biocbooktesting4:devel
```
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting4:devel bash
